<template>
    <div
        ...
        <router-link :to="`/producto/${product.slug || ''}`" class="block relative aspect-[3/4] bg-gray-100">
            ...
            <!-- Selector de tallas aparece al hover (sobrepuesto en la imagen) -->
            <div
                class="absolute bottom-0 left-0 right-0 bg-black/90 text-white opacity-0 group-hover:opacity-100 transition-shadow duration-300">
