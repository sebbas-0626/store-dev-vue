    ...
    <nav class="px-6 py-4">
      <div class="border-b-2 border-slate-300 flex justify-between py-4">
        ...
        <nav
          ...
          class="sm:flex sm:items-center flex-col sm:flex-row"
        >
          <div class="flex flex-row mt-3 gap-2">
            <div
              class="text-gray-600 hover:bg-gray-200 w-full text-left px-2 rounded hover:text-gray-900"
            >
